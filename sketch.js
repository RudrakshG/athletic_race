...
function setup() {
 ...
 // obstacle1.debug=true;
  ...
  trex = createSprite(width-1200,0,0,0);  
  ...
  ground = createSprite(0,height,12000,20);
 ...
 // ground.debug = true;
  ...
  gameOver = createSprite(width-750,height-520);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width-750,height-470);
...
function draw() {
  ...
  textFont("Georgia");
  textSize(40)
  text("ATHLETIC RACE", width-900,height-570);
...
function spawnObstacles() {
  if(frameCount % 80 === 0) {
    var obstacle = createSprite(width-200,height-80,30,40);
    //obstacle.debug = true;
